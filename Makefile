...
help: ## Display available commands
	@echo "lucene Development Commands"
	@echo "=============================="
...
coverage: ## Generate coverage report (unit + integration)
	...
	@go test -tags "testing integration" -coverprofile=coverage-integration.out -covermode=atomic ./testing/integration/... 2>/dev/null || true
